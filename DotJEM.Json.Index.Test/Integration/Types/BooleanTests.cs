...
namespace DotJEM.Json.Index.Test.Integration.Types
{
    public class BooleanTests
    {
        ...
        public void Search_Boolean_InverseleapYearDebug()
        {
            ...
            result.Any();
            Assert.That(result.TotalCount, Is.EqualTo(310));
        }
        ...
        private IEnumerable<JObject> TestObjects(int count)
        {
            ...
            return Enumerable
                ...
                .Select(id => new
                {
                    ...
                    area = "Test",
                    evenDay = now.Day % 2 == 0,
                    unevenDay = now.Day % 2 == 1,
                    evenMonth = now.Month % 2 == 0,
                    unevenMonth = now.Month % 2 == 1,
                    leapYear = DateTime.IsLeapYear(now.Year)
                })
