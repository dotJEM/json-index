...
namespace DotJEM.Json.Index.QueryParsers.Simplified
{
    ...
    {
        public virtual TResult Visit(QueryAst ast, TContext context) => default (TResult);
        public virtual TResult Visit(NotQuery ast, TContext context) => Visit((QueryAst)ast, context);

        public virtual TResult Visit(OrderedQuery ast, TContext context) => Visit((QueryAst)ast, context);
        public virtual TResult Visit(OrderBy ast, TContext context) => Visit((QueryAst)ast, context);
        public virtual TResult Visit(OrderField ast, TContext context) => Visit((QueryAst)ast, context);
        public virtual TResult Visit(FieldQuery ast, TContext context) => Visit((QueryAst)ast, context);
